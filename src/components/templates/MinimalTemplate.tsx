...
export default function MinimalTemplate({
  ...
  const SectionTitle = ({
    ...
    <h2
      ...
      className="font-semibold uppercase tracking-[0.2em] mb-3"
    >
      {children}
    </h2>
  );
  ...
  return (
    <div
      ...
      className="w-full h-full px-14 py-14"
    >
      <header className="mb-9 flex items-start justify-between gap-6">
        <div className="flex-1">
          ...
          <div
            ...
            className="flex flex-wrap gap-x-5 gap-y-1 mt-4"
          >
            {data.email && (
                ...
                cat.items.length > 0 ? (
                  ...
                  >
                    <div
                      ...
                      className="col-span-1 pt-0.5 font-medium"
                    >
                      {cat.name}
                    </div>
